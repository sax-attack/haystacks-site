...
const posts = [
  {
    title: 'Three Challenges Facing The Affordable Housing Market',
    link: 'https://www.forbes.com/sites/forbesbusinesscouncil/2022/08/08/three-challenges-facing-the-affordable-housing-market-and-how-industry-leaders-can-start-addressing-them/?sh=61cd89b53df4',
    date: 'August 08, 2022',
  },
  {
  ...
  {
    title:
      'Haystacks.AI Raises Another $3M for its Single-Family Rental Real Estate Data Platform That Helps Investors Source, Acquire, and Manage Their Investments',
    date: 'March 24, 2022',
  ...
  {
    title: 'Haystacks.AI Maintains Strong Momentum for 2022 With Additional Funding, Accelerated Growth',
    link: 'https://www.cretech.com/news/haystacks-ai-maintains-strong-momentum-for-2022-with-additional-funding-accelerated-growth/',
    date: 'March 22, 2022',
  },
  {
  ...
  {
    title: 'Inclusion in their Term Sheet Newsletter',
    link: 'https://fortune.com/newsletter/termsheet',
  ...
  return (
    <section className='container'>
      <div className='section'>
        <div className='px-24'>
          <h2 className='text-center font-rubik md:text-left py-16 md:py-40 text-lg md:text-3xl max-w-4xl'>
        ...
        <div className='flex flex-col md:flex-row justify-between flex-wrap'>
          {posts.map((post, index) => (
            <BlogPost key={index} title={post.title} link={post.link} date={post.date} className='md:w-[47%]' />
          ))}
        </div>
      </div>
    </section>
