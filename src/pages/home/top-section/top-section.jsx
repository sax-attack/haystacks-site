...
const HomeTopSection = () => {
  ...
  return (
    <div className='py-10 px-20 2xl:px-40 relative md:h-screen'>
      {isBiggerSm ? (
      ...
      <h2 className='font-extralight text-sm md:text-2xl max-w-2xl mt-4 md:mt-8 mb-20 md:leading-[40px] font-light'>
