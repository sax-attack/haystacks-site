...
import MobileLanding from '../../../assets/Mobile_Landing.mp4';
  ...
  return (
    <div>
      <video
        ...
        src={isBiggerSm ? Landing : MobileLanding}
      ></video>
      ...
      <div className='py-10 h-[80vh] px-14 2xl:px-40 relative md:h-screen'>
        ...
        <h2
          id='randomElement'
          className='font-extralight text-sm md:text-2xl max-w-2xl mt-4 md:mt-8 mb-28 md:mb-20 md:leading-[40px] font-light'
        >
          Haystacks.AI solves data inefficiences in real estate investment.
        </h2>

        <AnchorLink href='#demo' className='duration-300 hover:opacity-40'>
